...
import { TASK_COLUMNS, PRIORITY_CONFIG } from '@/lib/crm'
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity" onClick={e => e.stopPropagation()}>
                        <button onClick={() => moveTask(task.id, 'prev')} className="w-5 h-5 flex items-center justify-center rounded text-muted-foreground hover:text-foreground hover:bg-muted transition-all" title="Move left">
                          <ChevronLeft className="w-3 h-3" />
                        </button>
                        <button onClick={() => moveTask(task.id, 'next')} className="w-5 h-5 flex items-center justify-center rounded text-muted-foreground hover:text-foreground hover:bg-muted transition-all" title="Move right">
